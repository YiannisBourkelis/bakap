<#
.SYNOPSIS
  Interactive setup for automated Windows backup to termiNAS server.
...
Write-Host "termiNAS Windows Client Setup" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
Write-Log "=========================================="
Write-Log "termiNAS Backup Started - $jobName"
Write-Log "=========================================="
...
Write-Log "=========================================="
Write-Log "termiNAS Backup Finished"
Write-Log "=========================================="
"@
...
$taskName = "termiNAS-Backup-$jobName"
...
Register-ScheduledTask -TaskName $taskName `
    ...
    -RunLevel Highest `
    -Description "termiNAS automated backup for $jobName" | Out-Null
